      ...
      <div class="inbox_msg">
        <div class="inbox_people">
          ...
          <div class="inbox_chat">
            ...
            <div class="chat_list active_chat" id="chat-inbox">
              <?php foreach ($chat as $tampil) {
                # code...
              ?>

                <a href="#" onclick="detail_chat(<?= $tampil->hash ?>)">
                  <div class="chat_list">
                    <div class="chat_people">
                      <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                      <div class="chat_ib">
                        <h5><?= $tampil->nama_divisi ?> <span class="chat_date">Dec 25</span></h5>
                        <p><?= $tampil->pesan ?>'</p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="msg_history">
            <div class="incoming_msg">
              <div class="incoming_msg_img">
                ...
                <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"><span id="nama"></span> </div>
...
<script type="text/javascript">
  function detail_chat(hash) {
    ...
    var hash_id = hash;
    $.ajax({
      url: "<?= base_url('admin/detail_chat') ?>",
      type: "POST",
      data: {
        hash_id: hash_id
      },
