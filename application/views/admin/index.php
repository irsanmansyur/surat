                     ...
                     <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="divisi_nm" id="divisi_nm" required>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>Jabatan</label>
                                 <select class="form-control" name="jabatan_nm" id="jabatan_nm" required>
 ...
 <script type="text/javascript">
     $(document).ready(function() {
         ...
         $('#divisi_nm').change(function() {
             var divisi = $('#divisi_nm').val();
             //alert(divisi);
             $.ajax({
                 url: "<?= base_url("admin/cek_jabatan") ?>",
                 type: "POST",
                 data: {
                     divisi: divisi
                 },
                 success: function(data) {
                     $('#jabatan_nm').html(data);
