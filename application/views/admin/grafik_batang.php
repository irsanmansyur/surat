  <div class="right_col" role="main">
    <div class="row">
      <div class="x_panel">
        <form action="<?php echo base_url('admin/report_chart') ?>" method="post">
          <div class="col-md-3">
        ...
        <form action="<?php echo base_url('admin/keluar_bulan') ?>" method="post">
          <div class="col-md-3">
            <div class="form-group">
              <label>Bulan</label>
    ...
    ?>
      <script>
        ...
        var myChart = new Chart(ctx, {
          type: 'bar',
          data: {
            labels: [<?php foreach ($grafik as $tamp) {
                        echo  '"' . $tamp->tgl_berkas . '",';
                      } ?>],
            datasets: [{
              label: '# of Votes',
              data: [<?php foreach ($count as $tamp) {
                        echo  '"' . $tamp->jumlah . '",';
                      } ?>],
              backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
