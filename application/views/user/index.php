       ...
       <div class="row top_tiles">
           <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="tile-stats">
                   ...
                   <div class="count"><?= $kirim_surat; ?><!-- ganti ini dengan query jenis surat masuk --></div>
           ...
           <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="tile-stats">
                   ...
                   <div class="count"><?= $total_surat; ?> i<!-- ganti ini dengan query untuk surat keluar tanpa berkas --></div> 
