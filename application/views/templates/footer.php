<!-- footer content -->
<footer>
    <div class="pull-right md-12">
        Created : <strong>Indra Dev</strong> | Gentelella - Template by <a href="https://colorlib.com">Colorlib</a></a>
    </div>
...
<!-- Chart.js -->
<!--  <script src="<?= base_url('assets/'); ?>vendors/Chart/Chart.js"></script>-->
<!-- jQuery Sparklines -->
